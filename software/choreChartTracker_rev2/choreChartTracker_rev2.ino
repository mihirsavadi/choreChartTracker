/*
  Mihir Savadi 6th June 2021

  Changed to Arduino IDE from platformIO in rev1 because handling dependencies
  were getting too complicated, and wasnt able to upload simple things to the 
  board without spending a lot of time and effort.
